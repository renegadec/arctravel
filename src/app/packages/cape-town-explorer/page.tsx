...
import { Clock, MapPin, CheckCircle2, ArrowRight, Mountain } from "lucide-react";

export const metadata: Metadata = {
  title: "Cape Town Explorer — ArcTravel",
  description: "Discover the Mother City — Table Mountain, Cape Point, the Winelands, and stunning beaches. From US$1,250 per person.",
};
