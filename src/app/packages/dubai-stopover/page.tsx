...
import { Clock, MapPin, CheckCircle2, ArrowRight, Building } from "lucide-react";

export const metadata: Metadata = {
  title: "Dubai Stopover — ArcTravel",
  description: "Turn your layover into a mini-holiday — shopping, desert safaris, and iconic city sights. From US$1,100 per person.",
};

const pkg = packages[5];
