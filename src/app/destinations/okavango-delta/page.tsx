...
export default function OkavangoPage() {
  return (
    <>
      <section className="relative overflow-hidden bg-gradient-to-br from-[#2d5a3a] via-[#3d7a4a] to-[#2d6a3a] py-20 sm:py-24">
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <Link href="/book?destination=Okavango+Delta&notes=Okavango+Delta+destination+page" className="mt-8 inline-block"><Button size="lg" className="bg-[#ff8912] text-white hover:bg-[#e67a00] shadow-lg shadow-[#ff8912]/25 active:scale-[0.97] transition-all cursor-pointer">Safari to the Delta <ArrowRight className="ml-2 h-4 w-4" /></Button></Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-16"><div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8"><div className="rounded-xl border border-accent/20 bg-accent/[0.02] p-8 text-center sm:p-12"><TreePalm className="mx-auto h-10 w-10 text-accent" /><h2 className="mt-4 text-2xl font-bold">Ready for the Delta?</h2><p className="mx-auto mt-3 max-w-lg text-muted-foreground">Tell us your preferred dates and group size — we'll tailor a safari that fits.</p><Link href="/book?destination=Okavango+Delta&notes=Okavango+Delta+destination+page"><Button size="lg" className="bg-[#ff8912] text-white hover:bg-[#e67a00] shadow-lg shadow-[#ff8912]/25 active:scale-[0.97] transition-all cursor-pointer mt-6">Plan Your Safari</Button></Link></div></div></section>
    </>
  );
}
