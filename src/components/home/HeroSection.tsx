...
import { Compass, ArrowRight, MapPin, Star, Phone } from "lucide-react";
...
export default function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-[#002a62] via-[#002a62]/95 to-[#1a3a5c]">
      ...
      {/* Floating icons */}
      <div className="pointer-events-none absolute right-[12%] top-[25%] hidden animate-float opacity-25 lg:block">
        <Compass className="h-12 w-12 text-[#ff8912]" />
      </div>
      <div
        className="pointer-events-none absolute bottom-[20%] left-[12%] hidden animate-float opacity-25 lg:block"
        style={{ animationDelay: "2s" }}
      >
        <MapPin className="h-10 w-10 text-[#ff8912]" />
      </div>
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-24 sm:px-6 sm:py-32 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          {/* Subtext */}
          <p
            className="mx-auto mt-5 max-w-xl animate-slide-up text-lg leading-relaxed text-white/70"
          ...
          {/* Social proof */}
          <div
            className="mx-auto mt-6 flex animate-slide-up items-center justify-center gap-2 text-sm text-white/60"
          ...
          {/* Quick contact line */}
          <div
            className="mt-6 flex animate-slide-up items-center justify-center gap-1.5 text-sm text-white/50"
            style={{ animationDelay: "0.35s" }}
          >
            <Phone className="h-3.5 w-3.5" />
            <span>Or call us: </span>
            <a
              href="tel:+263 XXX XXX XXX"
